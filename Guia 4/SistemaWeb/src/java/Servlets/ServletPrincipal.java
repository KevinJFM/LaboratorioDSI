        ...
        if (accion.equals("Login")) {
            ...
            try (PrintWriter print = response.getWriter()) {
                if (usuario.equals("admin") && contrasenia.equals("root")) {
                    request.getRequestDispatcher("/indez.html").forward(request, response);
                } else {
                    print.println();
                    print.println("<!DOCTYPE html>");
                    print.println("<html>");
                    print.println("<head>");
                    print.println("<title>Login Sistema de Reservaciones</title>");
                    print.println("</head>");
                    print.println("<body>");
                    print.println("<h1>ERROR: El ususuario o la contraseña son erroneos.</h1>");
                    print.println("</body>");
                    print.println("</html>");
